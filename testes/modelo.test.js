...
// Novo teste para cadastro de uma resposta válida
test('Testando cadastrar uma resposta válida', () => {
  const idPergunta = modelo.cadastrar_pergunta('1 + 1 = ?');
  const idResposta = modelo.cadastrar_resposta(idPergunta, '2');
...
// Novo teste para testar obter uma pergunta
test('Testando a obtenção de uma pergunta cadastrada', () => {
  const idPergunta = modelo.cadastrar_pergunta('1 + 1 = ?');
...
// Novo teste para testar obter uma resposta
test('Testando a obtenção de respostas cadastradas', () => {
  const idPergunta = modelo.cadastrar_pergunta('1 + 1 = ?');
